...
def put_tasks(request):
    ...
    mods = [
        ...
        Selector(task_id='Wohnungen', name='adresse', type=1, xpath='//span[@class="street"]/text()', regex='[^\\n\\r ,.][^\\n\\r]+', is_key=False),
        Selector(task_id='Wohnungen', name='kaltmiete', type=0, xpath='//dd[preceding-sibling::dt/text()="Kaltmiete"]/text()', regex='\\d[\\d.,]*', is_key=False),
        Selector(task_id='Wohnungen', name='wohnflaeche', type=0, xpath='//dd[preceding-sibling::dt/text()="WohnflÃ¤che"]/text()', regex='\\d[\\d.,]*', is_key=False),
        Selector(task_id='Wohnungen', name='zimmeranzahl', type=3, xpath='//dd[preceding-sibling::dt/text()="Zimmer"]/text()[position() mod 2 = 1]', regex='\\d[\\d.,:]*', is_key=False),
        Selector(task_id='Wohnungen', name='url', type=1, xpath='//span[@class="title"]//a/@href', regex='[^\\n\\r ,.][^\\n\\r]+', is_key=False),
        Selector(task_id='Wohnungen', name='base_url', type=1, xpath='//link[@rel="canonical"]/@href', regex='.*\\.de', is_key=False),
        Selector(task_id='Wohnungen', name='title', type=1, xpath='//span[@class="title"]//a/@title', regex='[^\\n\\r ,.][^\\n\\r]+', is_key=False),
        UrlSelector(task_id='Wohnungen', url='http://www.immobilienscout24.de/Suche/controller/sorting.go?searchUrl=/Wohnung-Miete/Fahrzeitsuche/M_fcnchen/-/116301/2030629/-/-/30/1,50-/40,00-/EURO--900,00/-/-/-/-/-/-/-/-/-/-/-/-/true&sortingControl=2', selector_task_id='Wohnungen', selector_name='wohnungs_id', selector_name2='wohnungs_id'),

        Task(name='Wohnungen_2'),
        Selector(task_id='Wohnungen_2', name='adresse', type=1, xpath='//div[contains(@class,"listitem")]//div[contains(@class,"location")]/text()', regex='[^\\n\\r ,.].+', is_key=False),
        Selector(task_id='Wohnungen_2', name='kaltmiete', type=0, xpath='//div[contains(@class,"listitem")]//div[@class="hardfact"]/strong/text()', regex='\\d[\\d.,]*', is_key=False),
        Selector(task_id='Wohnungen_2', name='wohnflaeche', type=0, xpath='//div[contains(@class,"listitem")]//div[@class="hardfact"]/text()', regex='\\d[\\d.,]*', is_key=False),
        Selector(task_id='Wohnungen_2', name='wohnungs_id', type=1, xpath='//div[contains(@class,"listitem")]/a/@href', regex='/expose/([a-zA-Z0-9]+)', is_key=True),
        Selector(task_id='Wohnungen_2', name='zimmeranzahl', type=3, xpath='(//div[contains(@class,"listitem")]//div[@class="hardfact rooms"]//text())[position() mod 2 = 1]', regex='\\d[\\d.,:]*', is_key=False),
        Selector(task_id='Wohnungen_2', name='url', type=1, xpath='//div[contains(@class,"listitem")]/a/@href', regex='[^\\n\\r ,.][^\\n\\r]+', is_key=False),
        Selector(task_id='Wohnungen_2', name='base_url', type=1, xpath='//link[@hreflang="x-default"]/@href', regex='.*\\.de', is_key=False),
        Selector(task_id='Wohnungen_2', name='title', type=1, xpath='//div[contains(@class,"listitem")]//div[@class="listcontent"]/h3', regex='[^\\n\\r ,.][^\\n\\r]+', is_key=False),
        UrlSelector(task_id='Wohnungen_2', url='http://www.immowelt.de/immobilien/immoliste.aspx?geoid=10809162000006,10809162000016,10809162000017,10809162000019,10809162000020,10809162000026,10809162000027,10809162000003,10809162000002,10809162000031,10809162000008,10809162000028&etype=1&esr=2&eqid=1011&prima=1000&wflmi=30', selector_task_id='Wohnungen_2', selector_name='adresse', selector_name2='adresse'),

        Task(name='Wohnungen_3'),
        Selector(task_id='Wohnungen_3', name='adresse', type=1, xpath='id("table-compact-list")//td[@class="ang_spalte_stadt row_click"]//span/text()', regex='[^\\n\\r ,.][^\\n\\r]+', is_key=False),
        Selector(task_id='Wohnungen_3', name='kaltmiete', type=0, xpath='id("table-compact-list")//td[@class="ang_spalte_miete row_click"]//span/b/text()', regex='\\d[\\d.,]*', is_key=False),
        Selector(task_id='Wohnungen_3', name='wohnflaeche', type=0, xpath='id("table-compact-list")//td[@class="ang_spalte_groesse row_click"]//span/text()', regex='\\d[\\d.,]*', is_key=False),
        Selector(task_id='Wohnungen_3', name='wohnungs_id', type=1, xpath='id("table-compact-list")//td[@class="ang_spalte_groesse row_click"]/a/@href', regex='[^\\n\\r ,.][^\\n\\r]+', is_key=True),
        Selector(task_id='Wohnungen_3', name='zimmeranzahl', type=3, xpath='id("table-compact-list")//td[@class="ang_spalte_zimmer row_click"]//span/text()', regex='\\d[\\d.,:]*', is_key=False),
        Selector(task_id='Wohnungen_3', name='url', type=1, xpath='id("table-compact-list")//td[@class="ang_spalte_groesse row_click"]/a/@href', regex='[^\\n\\r ,.][^\\n\\r]+', is_key=False),
        Selector(task_id='Wohnungen_3', name='base_url', type=1, xpath='//link[@rel="canonical"]/@href', regex='(http://[^/]+).*', is_key=False),
        Selector(task_id='Wohnungen_3', name='title', type=1, xpath='id("table-compact-list")//td[@class="ang_spalte_stadt row_click"]//span/text()', regex='[^\\n\\r ,.][^\\n\\r]+', is_key=False),
        UrlSelector(task_id='Wohnungen_3', url='http://www.wg-gesucht.de/wohnungen-in-Muenchen.90.2.0.0.html?filter=e25a980657c1a13e4d78a142aacce07e5199a55c3599e5a309', selector_task_id='Wohnungen_3', selector_name='adresse', selector_name2='adresse'),
