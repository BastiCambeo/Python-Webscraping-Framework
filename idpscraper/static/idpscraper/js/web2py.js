    ...
    $.web2py = web2py = {
        ...
        ajax_page: function (method, action, data, target, element) {
            ...
            if (target == undefined || target == '')
                target = 'w2p_none';
            if (web2py.fire(element, 'ajax:before', null, target)) {
                $.ajax({
                    'type': method,
                    'url': action,
                    'data': data,
        ...
        calc_entropy: function (mystring) {
            ...
            var csets = new Array('abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', '0123456789', '!@#$\%^&*()', '~`-_=+[]{}\|;:\'",.<>?/', '0123456789abcdefghijklmnopqrstuvwxyz');
        ...
        validate_entropy: function (myfield, req_entropy) {
            if (myfield.data('w2p_entropy') != undefined)
                req_entropy = myfield.data('w2p_entropy');
            ...
            if (!myfield.hasClass('entropy_check'))
                myfield.on('keyup', validator).on('keydown', validator).addClass('entropy_check');
        },
        ...
        disableElement: function (el) {
            ...
            */
            ...
            el.bind('click.w2pDisable', function (e) {
        ...
        flash: function (message, status) {
            ...
            if (flash.html().trim())
                flash.append('<span id="closeflash"> &times; </span>').slideDown();
        },
        hide_flash: function () {
        ...
        a_handler: function (el, e) {
            ...
            if (confirm_message != undefined) {
                if (confirm_message == 'default')
                    confirm_message = w2p_ajax_confirm_message || 'Are you sure you want to delete this object?';
                if (!web2py.confirm(confirm_message)) {
...
//# sourceMappingURL=web2py.js.map